...
void main(List<String> arguments) {
   ...
   * Após popular essa lista, escreva uma função que ordene essa lista em ordem crescente, do menor para o maior.
   * Essa função deve receber por parâmetro uma lista de inteiros, e retornar uma nova lista de inteiros, ordenada.
   */
